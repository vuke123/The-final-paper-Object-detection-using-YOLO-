...
def intersection_over_union(boxes_preds, boxes_labels):
    box1_x1, box1_y1, box1_x2, box1_y2 = get_box_coordinates(boxes_preds)
    box2_x1, box2_y1, box2_x2, box2_y2 = get_box_coordinates(boxes_labels)
    ...
    #in case they do not interact
    intersection = torch.clamp(x2 - x1, min=0) * torch.clamp(y2 - y1, min=0)

    box1_area = calculate_box_area(box1_x1, box1_y1, box1_x2, box1_y2)
    box2_area = calculate_box_area(box2_x1, box2_y1, box2_x2, box2_y2)
...
def non_max_suppression(bboxes, iou_threshold, confidence_threshold):
    ...
    while bboxes:
        ...
        chosen_box_tensor = torch.tensor(chosen_box[2:])
