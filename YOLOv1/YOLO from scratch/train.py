...
def main():
    ...
    for epoch in range(EPOCHS):
        ...
        #        plot_image(x[idx].permute(1,2,0).to("cpu"), bboxes)
                                #change the order of dimensions of the image tensor. In this case, it permutes the dimensions so that the channels
                                #  (typically the last dimension) become the first dimension. 
        #    import sys
        #    sys.exit()
